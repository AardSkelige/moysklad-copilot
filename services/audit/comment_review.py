...
_STYLE = (
    ...
    f'6. Если автора в комментарии НЕТ — добавь вероятного по зоне ответственности '
    f'и типу документа: приёмки, заказы поставщику, производство → {AUTHOR_PURCHASES}; '
    f'заказы покупателей → {AUTHOR_SALES}, НО если контрагент {MARKETPLACES} → '
    f'{AUTHOR_MARKETPLACE}; платежи и финансы → {AUTHOR_FINANCE}. '
...
_DEMAND_SYSTEM = (
    ...
    f'({MARKETPLACES}) — {AUTHOR_MARKETPLACE}. '
